  ...
  return (
    <label className="block">
      ...
      <select
        ...
        className="min-h-12 w-full rounded-lg border border-ink-300 bg-white px-3 py-2.5 text-ink-900 outline-none focus:border-brand-600 focus:ring-2 focus:ring-brand-500/20"
      >
